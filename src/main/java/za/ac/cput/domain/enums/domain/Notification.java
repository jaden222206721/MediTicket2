...
import za.ac.cput.domain.enums.domain.enums.NotificationStatus;
import za.ac.cput.domain.enums.domain.enums.NotificationType;
import za.ac.cput.domain.enums.domain.user.Patient;
