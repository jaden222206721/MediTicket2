...
import za.ac.cput.domain.enums.domain.enums.PaymentMethod;
...
public class Payment {
    ...
    @Enumerated(EnumType.STRING)
    private za.ac.cput.domain.enums.domain.enums.PaymentStatus paymentStatus;

    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "appointment_id", unique = true) // Maps the foreign key column to Appointment
    private za.ac.cput.domain.enums.domain.Appointment appointment;
    ...
    public za.ac.cput.domain.enums.domain.enums.PaymentStatus getPaymentStatus() {
        return paymentStatus;
    }

    public za.ac.cput.domain.enums.domain.Appointment getAppointment() {
        return appointment;
    }
