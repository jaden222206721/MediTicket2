package za.ac.cput.domain.enums.domain.user;

import jakarta.persistence.Entity;
import jakarta.persistence.Table;
import za.ac.cput.domain.enums.domain.enums.UserStatus;
import za.ac.cput.domain.enums.domain.valueObject.Name;
